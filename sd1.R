...
##### Authors: Marco A. R. Mello, Gabriel M. Felix, 
##### Rafael B. P. Pinheiro, Renata L. Muylaert, 
##### Cullen Geiselman, Sharlene E. Santana, Marco Tschapka,
##### Nastaran Lotfi, Francisco A. Rodrigues & Richard D. Stevens
##### E-mail: marmello@gmail.com 
##### How to cite: Mello et al. 2018. Insights on the assembly rules
##### of a continent-wide multilayer network. Supplementary Data 1.
...
setwd("/Users/marco/Desktop/OneDrive/Publicacoes/Trabalhando/Morcegos Multicamada/Manuscript/Supplements/SD1")
rm(list=ls())
